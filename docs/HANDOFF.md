...
最終更新時の状態: バージョン 0.1.77 系 / Swift 6 / SwiftUI / SwiftData / iOS 17+。
...
別アプリ実験用の `AccelTimerX` は v0.1.76 以降、このリポジトリから外し
`/Users/user01/dev/AccelTimerX/AccelTimerX.xcodeproj` でローカル独立管理する。

**このセッション（〜v0.1.77）の主な変更:** ①課金を透かしモデル→トライアル課金へ全面変更
