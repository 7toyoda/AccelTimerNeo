...
最終更新時の状態: バージョン 0.1.83 系 / Swift 6 / SwiftUI / SwiftData / iOS 17+。
...
**このセッション（〜v0.1.83）の主な変更:** ①課金を透かしモデル→トライアル課金へ全面変更
...
テストimportも `AccelTimerNeo` へ揃えた（v0.1.83）。計測ロジックへの影響はない。
